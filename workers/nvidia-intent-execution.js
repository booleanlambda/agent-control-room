...
- Each agent independently chooses their own public name. Check identity_name_availability.unavailable_names; never reuse any exact or case-insensitive unavailable name. A previous choice can be rejected for colliding with an earlier agent. The runtime does not supply or pick a replacement. Do not copy another agent's name, memory or identity.
