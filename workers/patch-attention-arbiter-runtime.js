...
function headers() {
  ...
  return {
    ...
    'user-agent': 'AAU-Attention-Arbiter-Patcher/0.2',
  };
}
...
function patch(source) {
  ...
  next = replaceOnce(next, `const { ai, decision, intentRepairAttempted, identityRepairAttempts, embodimentRepairAttempts, fileReplyRepairAttempts, packetText } = await getDecision(packet, model);`, `const { ai, decision, intentRepairAttempted, identityRepairAttempts, embodimentRepairAttempts, fileReplyRepairAttempts, attentionResolutionRepairAttempts, packetText } = await getDecision(packet, model);`, 'destructure');

  next = next.replace(`executor_version: 'executor_v0_20_nvidia_embodiment_payload_normalization',`, `executor_version: 'executor_v0_21_attention_arbiter',`);
  next = next.replace(`prompt_version: 'persistent_agent_system_prompt_nvidia_v0_10_embodiment_object_schema',`, `prompt_version: 'persistent_agent_system_prompt_nvidia_v0_11_attention_arbiter',`);
  next = next.replace(`lifecycle_contract: 'next_intent_protocol_v0_1+identity_completion_same_intent_v0_1+embodiment_selection_same_intent_v0_1+expertise_artifact_stage_contract_v0_1+stage_action_alignment_v0_1+failure_diagnostics_v0_1+embodiment_payload_normalization_v0_1',`, `lifecycle_contract: 'next_intent_protocol_v0_1+identity_completion_same_intent_v0_1+embodiment_selection_same_intent_v0_1+expertise_artifact_stage_contract_v0_1+attention_arbiter_v0_1+attention_resolution_repair_v0_1+stage_action_alignment_v0_1+failure_diagnostics_v0_1+embodiment_payload_normalization_v0_1',`);
  next = next.replace(`      file_reply_repair_attempts: fileReplyRepairAttempts,\n      file_response_contract: 'file_response_repair_v0_1',`, `      file_reply_repair_attempts: fileReplyRepairAttempts,\n      attention_resolution_repair_attempts: attentionResolutionRepairAttempts,\n      attention_arbiter_contract: 'attention_arbiter_v0_1+attention_resolution_repair_v0_1',\n      file_response_contract: 'file_response_repair_v0_1',`);
  next = next.replace(`      file_reply_repair_attempts: fileReplyRepairAttempts,\n      usage:`, `      file_reply_repair_attempts: fileReplyRepairAttempts,\n      attention_resolution_repair_attempts: attentionResolutionRepairAttempts,\n      usage:`);
