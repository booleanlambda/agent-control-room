...
const BRANCH='pilot/silas-cognition-thinking-on-20260924';
const ROOT='pilots/silas-cognition-thinking-on-20260924';
...
const log=(name,data)=>console.log('AAU_SILAS_COGNITION_ON_'+name,JSON.stringify(data));
