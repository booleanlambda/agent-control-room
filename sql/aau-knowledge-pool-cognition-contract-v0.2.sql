-- Knowledge Pool v0.2: explicitly instruct model to review and return dated, source-backed seed_item_ids.
-- Live Supabase patch applied 2026-09-20. Preserve knowledge pool feature flag and v0.1 hooks.
