-- AAU deep cognition checkpoint v0.4 agent-native recursive decomposition
...
begin
  ...
  if p_action='save' then
    ...
    where agent_lab.deep_cognition_checkpoints.created_at < now()-interval '24 hours'
       or coalesce(agent_lab.deep_cognition_checkpoints.cognitive_metadata->>'contract','') not like '%agent_native_recursive_decomposition_v0_1%';
  end if;
  ...
  return jsonb_build_object(
    'status','ready','version','deep_cognition_checkpoint_v0_4_agent_native_recursive_decomposition',
