-- AAU recursive-cognition-aware orphan recovery v0.3
    ...
    if r.attempts>=3 and (
         ...
         set status='queued',worker_id=null,claimed_at=null,started_at=null,
             ...
             metadata=(coalesce(q.metadata,'{}'::jsonb)
               ...
               ||jsonb_build_object(
                 ...
                 'orphan_recovery_version','recursive_cognition_orphan_recovery_v0_3',
      ...
      update agent_lab.autonomous_lifecycle_runs
         set status='degraded',
             ...
             metadata=coalesce(metadata,'{}'::jsonb)||jsonb_build_object(
               ...
               'checkpoint_orphan_recovery_version','recursive_cognition_orphan_recovery_v0_3',
      ...
      values(r.agent_id,'orphaned_autonomous_intent_recovered','warning',
             ...
             jsonb_build_object('worker_id',r.worker_id,'started_at',r.started_at,
               ...
               'recovery_version','recursive_cognition_orphan_recovery_v0_3'))
