-- AAU controlled remediation after both initial retry generations exhausted due to malformed planner JSON.

-- Only operator remediation of the exact runtime parser failure can use a third retry generation; genuine test failures remain authoritative.
