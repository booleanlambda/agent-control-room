...
AAU v0.12 preserves prior agent history.
...
**understand value creation → choose a viable expertise → build deep expertise → prove applied execution → operate autonomously**
